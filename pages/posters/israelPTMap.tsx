...
import styles from "./israelPTMap.module.css";
...
export async function getServerSideProps(context) {
  ...
  const routeDesignConfig = await fetch(
    `${server}/api/routeDesignConfigIsraelPTMap?routeID=${context.query.routeID}`
  );
  return {
    props: {
          ...
          <div>
            ...
            <div className={styles.posterContainer}>
              ...
              <div className={styles.mapContainer}>
                <Map
                  multiPolyLine={[routeData.polyLines['189']]}
                  polyLines={routeData.polyLines}
                  stops={routeData.stops}
                  backgroundColor={'#FFFFFF'}
                  tileLayerName={'StamenToner'}
                  pathColor={'Snow'} //irrelevant
                  mapZoom={14}
                  font={'Johnston'}
                  showMarkers={false}
                />
